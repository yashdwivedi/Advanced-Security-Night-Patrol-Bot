...
public class CurrDetection extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_curr_detection);
    ...
    public void send_data(String str)
    {
       ...
       /* float pitch = 1f;
        ...
        Intent categoryIntent=new Intent(CurrDetection.this,invisible_button.class);
